...
public class MainServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		resp.getWriter().println("3. The count of all nationalities [(start), (end)]");
		resp.getWriter().println("4. The count of all overall rating [(start), (end)]");
		resp.getWriter().println("5. The count of all potential ratings [(start), (end)]");
		resp.getWriter().println("6. The average value in Euros of all players");
		resp.getWriter().println("7. The number of 5 star, 4 star, 3 star, 2 star, 1 star weak foot players [(start), (end)]");
		resp.getWriter().println("8. The number of  5 star, 4 star, 3 star, 2 star, 1 star skill moves players [(start), (end)]");
		resp.getWriter().println("9. The count of all positions in the game [(start), (end)]");
